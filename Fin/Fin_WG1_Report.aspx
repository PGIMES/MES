<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Fin_WG1_Report.aspx.cs" Inherits="Fin_Fin_WG1_Report" %>
        ...
        <div class="col-sm-12 ">
            <div class="panel panel-info">
                ...
                <td>
                  ...
                  <td align="right">&nbsp;&nbsp;</td>
                <td ><asp:Button ID="Button1" runat="server" Text="汇入进口费用" 
                        class="btn btn-lg btn-primary" Width="180px" Height="45px" 
                 ...
                 <td>     
                  <input id="File1" style ="width: 300px"   type="file" runat="server" />
                     <asp:Button ID="Button2" runat="server" Text="上传"  
                         ...
                         NavigateUrl="~/Fin/进口费用上传格式.xlsx">进口费用上传格式</asp:HyperLink>
                               </td>
