<%@ Page Title="【清关税费暂估分析】" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Fin_QGSF_Query.aspx.cs" Inherits="Fin_Fin_QGSF_Query" %>
    ...
    <div class="col-sm-12" id="div_p" style="margin-bottom:5px"> 
        <table style="line-height:40px;">
            <tr>
                ...
                <td>&nbsp;&nbsp;税费类型：</td>
                <td>
                    <asp:DropDownList ID="ddl_sf_type" runat="server" class="form-control input-s-sm ">
                        <asp:ListItem Value="">全部</asp:ListItem>
