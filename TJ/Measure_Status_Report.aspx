<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Measure_Status_Report.aspx.cs" Inherits="TJ_Measure_Status_Report" %>
        ...
        <div class="panel panel-heading">
            <asp:Label ID="lblYear" runat="server" Text="年"></asp:Label>
                  ...
                  <asp:Chart ID="Chart_xl" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
                      ...
                      <Series>
                          <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line"
                              LabelBorderWidth="9" Legend="Default" LegendText="测量效率(月)"
                  ...
                  <asp:Chart ID="Chart_ljhgl" runat="server" BackColor="#F3DFC1"
                      BackGradientStyle="TopBottom" BorderColor="181, 64, 1" BorderDashStyle="Solid"
                      BorderWidth="2" Height="200px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)"
                      ImageType="Png" Palette="none" Width="500px">
                      <Legends>
                      ...
                      <Series>
                          <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line"
                              LabelBorderWidth="9" Legend="Default" LegendText="零件合格率%"
                              MarkerSize="8" MarkerStyle="Circle" Name="Series1" ShadowOffset="3">
                          </asp:Series>
                          <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line"
                              LabelBorderWidth="9" Legend="Default" LegendText="批次合格率%"
                              MarkerSize="8" MarkerStyle="Circle" Name="Series2" ShadowOffset="3">
                          </asp:Series>
                      </Series>
                      <ChartAreas>
                          <asp:ChartArea BackColor="64, 165, 191, 228" BackGradientStyle="TopBottom"
      ...
      <div class=" panel panel-info col-lg-7">
        <div class="panel panel-heading">
          ...
          <asp:Chart ID="Chart_xl_day" runat="server" BackColor="#F3DFC1"
              ...
              <Series>
                  <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line"
                      LabelBorderWidth="9" Legend="Default" LegendText="测量效率(日)"
                      MarkerSize="8" MarkerStyle="Circle" Name="Series1" ShadowOffset="3">
                  </asp:Series>
              </Series>
              <ChartAreas>
          ...
          <asp:Chart ID="Chart_ljhgl_day" runat="server" BackColor="#F3DFC1"
              BackGradientStyle="TopBottom" BorderColor="181, 64, 1" BorderDashStyle="Solid"
              BorderWidth="2" Height="200px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)"
              ImageType="Png" Palette="none" Width="750px">
              <Legends>
