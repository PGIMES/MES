...
public partial class TJ_Measure_LYL_Report : System.Web.UI.Page
{
    ...
    {
        DataSet ds = Query("exec usp_Measure_lyl_Report_Modify '1','" + this.txt_year.SelectedValue + "','" + txt_month.Text + "','" + ddl_lab.SelectedValue + "','" + ddl_sjlb.SelectedValue + "','" + txt_ljh.Text + "','" + txt_gxh.Text + "','" + txt_csr.Text + "','" + ddl_sb.SelectedValue + "','" + ddl_xmh.SelectedValue + "'");
    ...
    {
        DataSet ds = Query("exec usp_Measure_lyl_Report_Modify '2','" + this.txt_year.SelectedValue + "','" + month + "','" + ddl_lab.SelectedValue + "','" + ddl_sjlb.SelectedValue + "','" + txt_ljh.Text + "','" + txt_gxh.Text + "','" + txt_csr.Text + "','" + ddl_sb.SelectedValue + "','" + ddl_xmh.SelectedValue + "'");
