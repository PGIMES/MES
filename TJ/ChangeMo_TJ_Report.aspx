<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeMo_TJ_Report.aspx.cs" Inherits="TJ_ChangeMo_TJ_Report" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <table>
            <tr>
                ...
                <td>
                    设备简称</td>
                <td>
                    <asp:DropDownList ID="selsbname" runat="server" class="form-control input-s-sm">
                    </asp:DropDownList>
                </td>
                <td>
                    模具类型</td>
                <td>
                    <asp:TextBox ID="txt_moju_type" runat="server" class="form-control input-s-sm"></asp:TextBox>
                </td>
                <td>
    ...
    <div class="panel panel-info col-lg-5">
        ...
        <div class="panel panel-body" style="  overflow:scroll">
            ...
            <asp:Chart ID="ChartYear_zys" runat="server" 
                    BackColor="#F3DFC1" BackGradientStyle="TopBottom" 
                    BorderColor="181, 64, 1" BorderDashStyle="Solid" 
                    BorderWidth="2" Height="150px" 
                    ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" 
                    ImageType="Png" Palette="none" Width="700px">
                    <Legends>
                    ...
                    <Series>
                        <asp:Series BorderWidth="3" ChartArea="ChartArea1" 
                            ...
                            LegendText="月总换模用时" MarkerSize="8" MarkerStyle="Circle" 
                            Name="月总换模用时" ShadowOffset="3">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea BackColor="64, 165, 191, 228" 
                            ...
                            <Area3DStyle Inclination="15" IsClustered="False" 
                                ...
                                WallWidth="0" />
                            <AxisY IntervalType="Number" LineColor="64, 64, 64, 64" 
                                TitleAlignment="Far">
            ...
            <asp:Chart ID="ChartYear_ys" runat="server" 
                    BackColor="#F3DFC1" BackGradientStyle="TopBottom" 
                    BorderColor="181, 64, 1" BorderDashStyle="Solid" 
                    BorderWidth="2" Height="150px" 
                    ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" 
                    ...
                    <Series>
                        <asp:Series BorderWidth="3" ChartArea="ChartArea1" 
                            ChartType="Line" LabelBorderWidth="9" Legend="Default" 
                            LegendText="单次换模用时" MarkerSize="8" MarkerStyle="Circle" 
                            Name="单次换模用时" ShadowOffset="3">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea BackColor="64, 165, 191, 228" 
                ...
                <asp:Chart ID="ChartYear_cs" runat="server" 
                    BackColor="#F3DFC1" BackGradientStyle="TopBottom" 
                    BorderColor="181, 64, 1" BorderDashStyle="Solid" 
                    BorderWidth="2" Height="150px" 
                    ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" 
                    ...
                    <Series>
                        <asp:Series BorderWidth="3" ChartArea="ChartArea1" 
                            ChartType="Line" LabelBorderWidth="9" Legend="Default" 
                            LegendText="月单机换模次数" MarkerSize="8" MarkerStyle="Circle" 
                            Name="单机换模次数" ShadowOffset="3">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea BackColor="64, 165, 191, 228" 
    ...
    <div class="panel panel-info col-lg-7">
        <div class="panel panel-heading">
            ...
            <asp:Chart ID="ChartMonth_ys" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
            BorderColor="181, 64, 1" BorderDashStyle="Solid" BorderWidth="2" Height="150px"
            ...
            <Series>
                <asp:Series BorderWidth="3" ChartArea="ChartArea1" 
                    ...
                    Legend="Default" LegendText="换模用时" MarkerSize="8" 
                    MarkerStyle="Circle" Name="换模用时"
        ...
        <asp:Chart ID="ChartMonth" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
            ...
            <Series>
                <asp:Series BorderWidth="3" ChartArea="ChartArea1" 
                    ChartType="Line" LabelBorderWidth="9"
                    Legend="Default" LegendText="单次换模用时" MarkerSize="8" 
                    MarkerStyle="Circle" Name="单次换模用时"
                    ShadowOffset="3" XValueMember="Days" 
                    YValueMembers="weight">
                </asp:Series>
            </Series>
         ...
         <asp:Chart ID="ChartMonth_cs" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
            BorderColor="181, 64, 1" BorderDashStyle="Solid" BorderWidth="2" Height="150px"
            ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" Palette="none"
            Width="800px">
            <Legends>
            ...
            <Series>
                <asp:Series BorderWidth="3" ChartArea="ChartArea1" 
                    ChartType="Line" LabelBorderWidth="9"
                    Legend="Default" LegendText="单机换模次数" MarkerSize="8" 
                    MarkerStyle="Circle" Name="单机换模次数"
                    ShadowOffset="3" XValueMember="Days" 
                    YValueMembers="weight">
                </asp:Series>
            </Series>
    ...
    <div class="panel panel-info col-lg-12">
        ...
        <asp:GridView ID="GridViewDay" BorderColor="LightGray"  CssClass="gvHeader"
            ...
            Width="1600px" 
            onrowdatabound="GridViewDay_RowDataBound" 
            ShowFooter="True" onrowcreated="GridViewDay_RowCreated">
            <Columns>
                <asp:BoundField DataField="change_date" HeaderText="日期">
                    <HeaderStyle BackColor="#C1E2EB" />
                </asp:BoundField>
                <asp:BoundField DataField="equip_name" HeaderText="设备名称">
                    <HeaderStyle BackColor="#C1E2EB" />
                </asp:BoundField>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                ...
                <asp:BoundField DataField="moju_type_up" 
                    HeaderText="上模模具类型" ItemStyle-HorizontalAlign="Right">
                    <HeaderStyle BackColor="#C1E2EB" />
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                ...
                <asp:BoundField DataField="moju_type_down" 
                    HeaderText="下模模具类型" ItemStyle-HorizontalAlign="Right">
                    <HeaderStyle BackColor="#C1E2EB" />
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                ...
                <asp:BoundField DataField="reason_type" HeaderText="换模原因类别" 
                    ItemStyle-HorizontalAlign="Right">
                    <HeaderStyle BackColor="#C1E2EB" />
