...
public partial class Production_Bmw_Yx1 : System.Web.UI.Page
{
    ...
    {
        string lssql = "exec Bmw_Yx_Query '" + this.txtdate1.Text+"','"+this.txtdate2.Text+"'";
        DataTable ldt = DbHelperSQLProductionData.Query(lssql).Tables[0];
       
       
        Pgi.Auto.Control.SetGrid("Bmw_1_Yx", "HEAD", this.gv1, ldt);
