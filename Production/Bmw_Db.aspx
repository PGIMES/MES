<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Bmw_Db.aspx.cs" Inherits="Production_Bmw_Db"  EnableEventValidation="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server" >
    ...
    <script type="text/javascript" language="javascript">
        ...
        $("#mestitle").text("【BMW/打标/<%=this.m_slocation%>记录】");
    </script>
    <style type="text/css">
        .row {
            margin-right: 2px;
