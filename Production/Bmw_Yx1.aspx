<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Bmw_Yx1.aspx.cs" Inherits="Production_Bmw_Yx1"  EnableEventValidation="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $("#mestitle").text("【BMW/装配测漏/1#装销钉-73记录】");
    </script>
    <style type="text/css">
        .row {
            margin-right: 2px;
