<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Bmw_M1460_Ygz1.aspx.cs" Inherits="Production_Bmw_M1460_Ygz1"  EnableEventValidation="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $("#mestitle").text("【BMW/装配测漏/1#装钢珠-85/81记录】");
    </script>
    <style type="text/css">
        .row {
            margin-right: 2px;
