...
public partial class Production_Bmw_M1460_Ygz1 : System.Web.UI.Page
{
    ...
    {
        string lssql = "exec Bmw_M1460_Ygz_Query '" + this.txtdate1.Text+"','"+this.txtdate2.Text+"'";
        DataTable ldt = DbHelperSQLProductionData.Query(lssql).Tables[0];
       
       
        Pgi.Auto.Control.SetGrid("Bmw_M1460_Ygz", "HEAD", this.gv1, ldt);
    ...
    protected void gv1_HtmlDataCellPrepared(object sender, DevExpress.Web.ASPxGridViewTableDataCellEventArgs e)
    {
        ...
        if (e.DataColumn.FieldName == "压装结果")
        {
