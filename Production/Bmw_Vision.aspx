<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Bmw_Vision.aspx.cs" Inherits="Production_Bmw_Vision"  EnableEventValidation="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $("#mestitle").text("【BMW/包装/<%=this.m_sorder_id%>记录】");
    </script>
    <style type="text/css">
        .row {
            margin-right: 2px;
