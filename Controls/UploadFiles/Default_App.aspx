<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default_App.aspx.cs" Inherits="WebForm.Controls.UploadFiles.Default_App" %>
            ...
            <table cellpadding="0" cellspacing="1" border="0" width="98%" align="center" style="margin-top:8px;">
                <tr>
                    <td style="height:40px;" id="uploadtable"><div id="picker" style="float:left;">选择文件</div>
                        <div class="uploadpress" style="width:60px;">
	        ...
	        <script type="text/javascript">
	            ...
	            $(function ()
	            {
	                ...
	                uploader.on('uploadProgress', function (file, percentage)
	                {
	                    ...
	                    $("#uploadpressdiv").text(width + '%').css("width", Math.round(60 / (percentage < 1 ? percentage * 100 : percentage)).toString() + "px");
	                });
