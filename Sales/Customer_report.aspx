<%@ Page Title="客户系统【客户查询】" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="Customer_report.aspx.cs" Inherits="Customer_report" %>
                    ...
                    <div class="col-sm-12">
                        <table class="tblCondition" >
                            ...
                            <tr>
                                <td>地区：</td>
                                <td>
                                                <asp:DropDownList ID="DDL_cm_region" class="form-control input-s-sm" Style="height: 35px; width: 150px" runat="server">
                                                </asp:DropDownList>
                                </td>
                                <td>发货终点代码：</td>
                                <td>
                                                        <input id="txtDebtorShipToCode" class="form-control input-s-sm" style="height: 35px; width: 150px" runat="server"  /></td>
                                 <td>发货终点名称：</td>
                                <td >
                                                        <input id="txtDebtorShipToName" class="form-control input-s-sm" style="height: 35px; width: 150px" runat="server"  /></td>
                                <td >
                                                    是否有效：</td>
                                <td>
                                                <asp:DropDownList ID="DDL_IsEffective" class="form-control input-s-sm" Style="height: 35px; width: 150px" runat="server">
                                                </asp:DropDownList>
                                </td>
                                 <td >
                            ...
                            <asp:BoundField DataField="AddressSearchName" HeaderText="搜索名称">
                             ...
                             <asp:BoundField DataField="requestid" HeaderText="requestid">
                                ...
                                <ItemStyle />
                                  ...
                                  <asp:BoundField DataField="cm_addr" HeaderText="PO工厂代码">
                                <HeaderStyle BackColor="#C1E2EB" Width="100px" Wrap="false" />
                                <ItemStyle />
                            </asp:BoundField>      
                                  <asp:BoundField DataField="AddressStreet1" HeaderText="地址">
                                <HeaderStyle BackColor="#C1E2EB" Width="350px" Wrap="false" />
                                <ItemStyle />
                            </asp:BoundField>       
