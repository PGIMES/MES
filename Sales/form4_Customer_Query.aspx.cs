...
public partial class form4_Customer_Query : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        sbSQL.Append("exec [form4_Customer_Query] ");
        sbSQL.Append("'" + this.txtBusinessRelationCode.Text.Trim() + "',");
        sbSQL.Append("'" + this.txtBusinessRelationName1.Text.Trim() + "',");
        sbSQL.Append("'" + this.txtAddressSearchName.Text.Trim()+"',");
        sbSQL.Append("'" + this.txtAddressStreet1.Text + "',");
        sbSQL.Append("'" + this.txtctry_country.Text + "',");
        sbSQL.Append("'" + this.ddlAddressIsTaxIncluded.SelectedValue+"',");
        sbSQL.Append("'" + this.txtDebtorShipToName.Text.Trim() + "',");
        sbSQL.Append("'" + this.txtcm_addr.Text+"'");
           ...
           //设定合并单元格后要显示连接的requestid
            ...
            {              
                ...
                {                    
                    ...
                    link.NavigateUrl = "Customer_QAD.aspx?requestid=" + GridView1.Rows[j].Cells[1].Text;
