<%@ Page Title="客户系统【任务查询】" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="Customer_Update_work.aspx.cs" Inherits="Customer_Update_list" %>
                        ...
                        <table class="tblCondition" >
                            <tr>
                                ...
                                <td class="auto-style1">
                                                完成状态</td>
                                <td class="auto-style1">
                                                <asp:DropDownList ID="DDL_zt" class="form-control input-s-sm" Style="height: 35px; width: 150px" runat="server">
                        ...
                        <Columns> 
                           ...
                           <asp:BoundField DataField="cmClassName" HeaderText="客户大类">
                            ...
                            <asp:BoundField DataField="AddressSearchName" HeaderText="搜索名称">
                             ...
                             <asp:BoundField DataField="Update_username" HeaderText="待处理人">
                                <HeaderStyle BackColor="#C1E2EB" Width="150px" Wrap="false" />
                                <ItemStyle />
                            </asp:BoundField> 
                                ...
                                <ItemStyle />
                                        ...
                                        <asp:BoundField DataField="zt" HeaderText="完成状态">
                                <HeaderStyle BackColor="#C1E2EB" Width="150px" Wrap="false" />
                                <ItemStyle />
                            </asp:BoundField>           
                        </Columns>
