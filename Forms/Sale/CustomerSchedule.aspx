...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#mestitle").html("【客户日程申请单】<a href='/userguide/CSGuide.pps' target='_blank' class='h5' style='color:red'>使用说明</a>");
                ...
                if(action=='submit'){   
                    ...
                    if($("[id$=gv] input[type!=hidden][id*=delivery_mode]").length==0){
                        ...
                        $("[id$=gv] tr[class*=DataRow]").each(function (index, item) { 
                            ...
                            if (isyn=="yes" && shipname=="") { msg+="【客户日程明细】-第"+(index+1)+"行【发货至名称】不可为空.<br />"; }
                    ...
                    $("[id$=gv] tr[class*=DataRow]").each(function (index, item) { 
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                //}
                                if (flag=="Y6") {
                                    msg+="【客户日程明细】-第" + (index+1) + "行【申请工厂】" + domain + "【物料号】" + part + "【发货自】" + site 
                                        + "【发货至】" + ship + "【模型年】" + modelyr + "必须唯一!<br />";
                                }
                            }
