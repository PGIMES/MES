...
public partial class Forms_PurChase_PUR_Report_price : System.Web.UI.Page
{
    ...
    {
        //
        DataTable dt = DbHelperSQL.Query("exec Pur_price_dj '" + txtwlh.Text + "','" + drop_gc.SelectedValue + "', '" + txtDateFrom.Text + "','" + txtDateTo.Text + "','" + (string)ViewState["empname"] + "'").Tables[0];
        this.GV_PART.Columns.Clear();
        Pgi.Auto.Control.SetGrid("Pur_price_dj", "", this.GV_PART, dt);
    ...
    protected void Bt_Export_Click(object sender, EventArgs e)
    {
        ...
        ASPxGridViewExporter1.WriteXlsToResponse("价格单" + System.DateTime.Now.ToString("yyyyMMdd"));//导出到Excel
    }
