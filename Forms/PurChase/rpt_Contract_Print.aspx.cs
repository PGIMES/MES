...
public partial class Forms_PurChase_rpt_Contract_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        report.Load(Server.MapPath("Contract_Print.frx"));//加载模板
        string lssql = "exec rpt_Contract_Print '{0}', '{1}', '{2}', '{3}'";
        ...
        report.Prepare();
        report.Export(pdf, Server.MapPath("contract.pdf"));
        Response.Redirect("contract.pdf");
    }
}