...
*/
    ...
    public void setread(int i,string formtype)
    {
        ...
        {
            ((ASPxComboBox)this.gvdtl.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gvdtl.Columns["wltype"], "wltype")).Enabled = false;
            ((ASPxComboBox)this.gvdtl.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gvdtl.Columns["wltype"], "wltype")).DisabledStyle.Border.BorderStyle = BorderStyle.None;
            ((ASPxComboBox)this.gvdtl.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gvdtl.Columns["wltype"], "wltype")).Width = Unit.Pixel(110);
            ((ASPxComboBox)this.gvdtl.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gvdtl.Columns["wltype"], "wltype")).DisabledStyle.BackColor = System.Drawing.Color.Transparent;
        }
    ...
    */
    ...
    protected void GetGrid(DataTable DT, string prtype_v)
    {
        ...
        */
        ...
        //物料类别
        DataTable ldt_wltype = null;
        if (prtype_v!="")
        {
            string sql_wltype = @"exec Pur_GetClassByPerson '" + CreateById.Text + "','" + prtype_v + "'";
            ldt_wltype = DbHelperSQL.Query(sql_wltype).Tables[0];
            //DataRow dr_wltype = ldt_wltype.NewRow(); dr_wltype["Class_ID"] = 0; dr_wltype["category_ms"] = "";
            //ldt_wltype.Rows.InsertAt(dr_wltype, 0);
            ldt_wltype.Columns["category_ms"].ColumnName = "value";
        }
        ...
        for (int i = 0; i < gvdtl.VisibleRowCount; i++)
        {
            ...
            if (this.gvdtl.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gvdtl.Columns["wltype"], "wltype") is ASPxComboBox)
            {
                ASPxComboBox tb2 = ((ASPxComboBox)this.gvdtl.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gvdtl.Columns["wltype"], "wltype"));
                tb2.DataSource = ldt_wltype;
                tb2.TextField = "value";
                tb2.ValueField = "value";
                tb2.DataBind();
                tb2.Value = DT.Rows[i]["wltype"].ToString();
            }
        }
