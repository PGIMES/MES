    ...
    <script type="text/javascript">
	   <%-- var initData = <%=BWorkFlow.GetFormDataJsonString(initData)%>;--%>
        ...
        function validate(id){
            ...
            if (!$("#gvdtl input[id*=wlmc]").attr("disabled")) {
                if($("#gvdtl input[id*=wlmc]").length==0){
                    layer.alert("请添加物料名称再提交发送.");
                    return false;
                }
            }else {
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                 <div style="float:left"><%--CssClass="form-control input-s-sm"--%>
                                                    <asp:DropDownList ID="domain" CssClass="linewrite" runat="server" Width="70px" Height="27px" ToolTip="0|1"  >
                                                        <asp:ListItem Value="" Text=""></asp:ListItem>
                                                        <asp:ListItem Value="200" Text="昆山工厂"></asp:ListItem>
                                                        <asp:ListItem Value="100" Text="上海工厂"></asp:ListItem>
                                                    </asp:DropDownList></div>  
                                                <div style="float:left"><%--CssClass="form-control input-s-sm"--%>
                                                    <asp:DropDownList ID="applydept" CssClass="linewrite" runat="server" Width="130px" Height="27px" ToolTip="0|1" >
                                                    </asp:DropDownList>
                                                </div>
                                            ...
                                            <td ><%--CssClass="form-control"--%>
                                                ...
                                                <asp:DropDownList ID="prtype" runat="server" CssClass="linewrite" ToolTip="0|1" Width="200px" Height="27px"></asp:DropDownList>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            <td>申请原因描述：</td>
                                ...
                                <div>                                    
                                    ...
                                    <asp:Button ID="btnDelete" runat="server" Text="删除"  CssClass="btn btn-primary btn-sm"   OnClick="btnDelete_Click"/>
                                        ...
                                        <dx:ASPxGridView ID="gvdtl" runat="server" Width="1200px" ClientInstanceName="grid" KeyFieldName="rowid" EnableTheming="True" Theme="MetropolisBlue" 
                                                Border-BorderColor="#DCDCDC" OnCustomCallback="gvdtl_CustomCallback">
