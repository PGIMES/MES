...
public partial class Pur_Po : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        List<TableRow> ls = ShowControl("PUR_PO_Main_Form", "HEAD_New_2", 5, "", "", "lineread", "linewrite");
        ...
        if (!IsPostBack)
        {
           ...
           */
            ...
            //,'['+pr.wlh+']'+case when left(pr.wlType,4)='4010' then right(pr.wlType,LEN(pr.wlType)-5) +'/'+pr.wlSubType else right(pr.wlType,LEN(pr.wlType)-5) end wlType
            lssql = @"select po.*
                        ...
                        ,pr.ApointVendorId,pr.unit,isnull(cast(pr.notax_historyPrice as nvarchar(max)),'新单价') notax_historyPrice,pr.notax_targetPrice,pr.deliveryDate,(pr.notax_targetPrice*pr.qty) as notax_targetTotalPrice,pr.attachments,pr.note
            ...
            if (this.m_sid == "")
            {
                ...
                if (LogUserModel != null)
                {
                    ...
                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$BuyerName")).Value = LogUserModel.UserId + "|" + LogUserModel.UserName;
                ...
                loadControl_Pay(ldt_pay);//Pgi.Auto.Control.SetGrid("PUR_PO_Main_Form", "PO_PAY", this.gv2, ldt_pay, 2);
            ...
            for (int i = 0; i < ldt_detail.Rows.Count; i++)
            {
                ...
                if (ldt_flow.Rows.Count == 0)
                {
                    ...
                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$PoType")).Enabled = false;
                    ((DropDownList)this.FindControl("ctl00$MainContent$PoDomain")).Enabled = false;
                    ((DropDownList)this.FindControl("ctl00$MainContent$AssetsAtt")).Enabled = false;
                    ...
                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$PoType")).CssClass = "lineread";
                    ((DropDownList)this.FindControl("ctl00$MainContent$PoDomain")).CssClass = "lineread";
                    ((DropDownList)this.FindControl("ctl00$MainContent$AssetsAtt")).CssClass = "lineread";
                    ...
                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$povendorid")).ControlStyle.BackColor = System.Drawing.Color.FromName("#FFFFFF");
                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$buyername")).ControlStyle.BackColor = System.Drawing.Color.FromName("#FFFFFF");
                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$PoType")).ControlStyle.BackColor = System.Drawing.Color.FromName("#FFFFFF");

                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$povendorid")).DisabledStyle.ForeColor = System.Drawing.Color.FromName("#333333");
                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$buyername")).DisabledStyle.ForeColor = System.Drawing.Color.FromName("#333333");
                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$PoType")).DisabledStyle.ForeColor = System.Drawing.Color.FromName("#333333");

                    ((ASPxComboBox)this.FindControl("ctl00$MainContent$povendorid")).DisabledStyle.Font.Bold = true;
                }
            ...
            for (int i = 0; i < ldt_pay.Rows.Count; i++)
            {
                ...
                if (ldt_flow.Rows.Count == 0)
                {
                    ...
                    ((ASPxComboBox)this.gv2.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gv2.Columns["PayClause"], "PayClause")).Width = Unit.Pixel(80);
                    ...
                    ((ASPxComboBox)this.gv2.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gv2.Columns["PayFunc"], "PayFunc")).Width = Unit.Pixel(80);
                    ...
                    ((ASPxComboBox)this.gv2.FindRowCellTemplateControl(i, (GridViewDataColumn)this.gv2.Columns["PayFile"], "PayFile")).Width = Unit.Pixel(100);
        ...
        //获取采购类别
        SetPoType(((ASPxComboBox)this.FindControl("ctl00$MainContent$buyername")).Value.ToString());
        ...
        ((ASPxComboBox)this.FindControl("ctl00$MainContent$PoVendorId")).ClientSideEvents.ValueChanged = "function(s, e) {vendorid(s);}";
        //((ASPxComboBox)this.FindControl("ctl00$MainContent$buyername")).ClientSideEvents.ValueChanged = "function(s, e) { buyername_potype_change('buyer',s);}";
        ((ASPxComboBox)this.FindControl("ctl00$MainContent$PoType")).ClientSideEvents.ValueChanged = "function(s, e) { buyername_potype_change('potype',s);}";
    ...
    public void loadControl(DataTable ldt_detail)
    {
        ...
        {
            ldt_2.Rows.Clear();
            ((DropDownList)this.FindControl("ctl00$MainContent$paytype")).SelectedValue = "";
        }
    ...
    private bool SaveData()
    {
        ...
        if (ldt.Rows.Count > 0)
        {
            ...
            List<Pgi.Auto.Common> ls1 = Pgi.Auto.Control.GetList(ldt, "PUR_PO_Dtl_Form", "id"
                , "flag,wlType,wlSubType,wlh,wlmc,wlms,wldesc,notax_targetPrice,notax_targetTotalPrice,RecmdVendorName,notax_historyPrice,deliveryDate,RecmdVendorId,attachments,attachments_name,pt_status,note");
    ...
    protected void gv_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
    {
        if (Session["pr_select"] != null)
        {
            ...
            for (int i = 0; i < ldt1.Rows.Count; i++)
            {
                ...
                ldr["note"] = ldt1.Rows[i]["note"].ToString();
    ...
    protected void gv_HtmlRowCreated(object sender, DevExpress.Web.ASPxGridViewTableRowEventArgs e)
    {
        ...
        string potype = "";
        if (this.FindControl("ctl00$MainContent$PoType") is ASPxComboBox)
        {
            if (((ASPxComboBox)this.FindControl("ctl00$MainContent$PoType")).Value != null)
            {
                potype = ((ASPxComboBox)this.FindControl("ctl00$MainContent$PoType")).Value.ToString();
    ...
    {
        ScriptManager.RegisterStartupScript(this, e.GetType(), "gridkey", "init_pay();", true);
    }
    ...
    protected void gv2_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
    {
        ...
        {
            string paytype_page = ((DropDownList)this.FindControl("ctl00$MainContent$paytype")).SelectedValue;//当前付款类型

            DataTable ldt_pay = DbHelperSQL.Query("select * from PUR_PO_ContractPay_Form where 1=0").Tables[0];

            string pono = ((TextBox)this.FindControl("ctl00$MainContent$pono")).Text;
            string sql = @"select * from PUR_PO_ContractPay_Form where pono='" + pono + "' order by rowid";
