...
public partial class Product_Rpt_ProductBom_Query : System.Web.UI.Page
{
    ...
    private void BindTreeData(string strpgitemp)
    {
        ...
        ps_par PID,cast(pt_net_wt as float) 重量,pt_ord_mult 最小包装量 FROM [172.16.5.6].[Report].[dbo].[qad_ps_mstr] a join [dbo].[qad_pt_mstr] b on a.ps_comp=b.pt_part  and a.ps_domain=b.pt_domain    
