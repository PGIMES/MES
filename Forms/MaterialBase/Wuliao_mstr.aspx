<%@ Page Title="生产性物料申请" Language="C#" AutoEventWireup="true" CodeFile="Wuliao_mstr.aspx.cs" Inherits="Forms_MaterialBase_Wuliao_mstr"
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            // $("select[id*='unit']").val("Kg");
            $("select[id*='unit']").val($("select[id*='unit']").val() == "" ? "Kg" : $("select[id*='unit']").val());
            $("select[id*='gc_version']").val($("select[id*='gc_version']").val() == "" ? "A" : $("select[id*='gc_version']").val());
            $("select[id*='bz_version']").val($("select[id*='bz_version']").val() == "" ? "A" : $("select[id*='bz_version']").val());
            ...
            if ((paramMap.state == "edit") && (arr[0] == "产成品")) {
...
//            var comp = $("#comp").val();
    ...
    <style type="text/css">       
        .lineread{
            font-size:9px; border:none; border-bottom:1px solid lightgray;background-color:#ffffff;width:90%;
        }
         .line{
            font-size:9px; border:none; border-bottom:1px solid lightgray; width:90%;
        }
        .linewrite{
            font-size:9px; border:none; border-bottom:1px solid #ccc;background-color:#FDF7D9;width:90%;/*EFEFEF*/
        }
            ...
            if( $("#isfx").attr("readonly")!="readonly"&& $("#isfx").val()=="")
             ...
             if($("#pt_pm_code").attr("readonly")!="readonly"  && $("#pt_pm_code").val()=="")
              ...
              if( $("#aqtj_wuliu").attr("readonly")!="readonly"&& $("#aqtj_wuliu").val()=="")
                 ...
                 if( $("#aqtj_wuliu").attr("readonly")!="readonly"&& $("#aqtj_wuliu").val()!="" && re.test($("#aqtj_wuliu").val())==false)
                 {  msg+="请正确填写主地点【安全提前期】,数值型.<br />"};
             ...
             if( $("#quantity_max").attr("readonly")!="readonly" && $("#quantity_max").val()=="" )
              ...
              if( $("#ddbs").attr("readonly")!="readonly" && $("#ddbs").val()=="" )
               {  msg+="请填写主地点【订单倍数】.<br />"};   
                ...
                if( $("#ddsl").attr("readonly")!="readonly" && $("#ddsl").val()==""  && r.test($("#ddsl").val())==false)
            ...
            if(!parent.checkSign()){
               ...
               $.ajax({
                   type: "post",
                    ...
                    data: "{'xmh':'" + wlh + "','cpleibie':'" + line + "','gc':'" + gc + "' ,'bz':'" + bz + "' , 'comp':'" + comp + "', 'formno':'" + formno + "', 'hz':'" + hz + "', 'state':'" + state + "', 'status':'" + status + "', 'aprover':'" + aprover + "'}",
                   contentType: "application/json; charset=utf-8",
                   dataType: "json",
                    async: false,//默认是true，异步；false为同步，此方法执行完在执行下面代码
        ...
        <div class="col-md-10">
                            ...
                            <div class="col-xs-12 col-sm-12  col-md-12 col-lg-12">
                                <div class="">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:250px">
                                             <asp:TextBox runat="server" ID="Formno" class="line"  Style=" width: 180px; font-size:12px" ReadOnly="True"></asp:TextBox>
                            ...
                            <div class="">
                                    ...
                                    <table style="width: 80%" border="0" runat="server" id="tblWLLeibie">
                                        <tr>
                                            <td>申请工厂</td>
                                            <td>
                                                <input id="Checkbox1" type="checkbox" value="200" runat="server"  name="fac"/>昆山工厂 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                                                <input id="Checkbox2" type="checkbox" value="100"  runat="server" name="fac"/>上海工厂
                                                  <asp:TextBox ID="comp" runat="server" ToolTip="0|0" Width="40"  CssClass=" hidden"/>
                                                </td>
                                                    <td>物料申请类型</td>
                                            <td>
                                                <asp:DropDownList ID="type" runat="server" CssClass="form-control" ToolTip="0|1"   Width="180px">
                                                   ...
                                                   <asp:TextBox ID="applytype" runat="server" ToolTip="0|0" Width="40"  CssClass=" hidden"/>
                                                    <asp:TextBox ID="role" runat="server" ToolTip="0|0" Width="40"  CssClass=" hidden"/>
                                                      <asp:TextBox ID="opinion" runat="server" ToolTip="0|0" Width="40"  CssClass=" hidden"/>
            ...
            <div class="row  row-container"  id="div_FX"   runat="server"   >
                ...
                <div class="panel-heading" data-toggle="collapse" data-target="#PD">
                        <strong>物料分销点数据/计划数据<span id="warnmsg" style="color: red; display: none">此单为分销点数据修改，请谨慎.</strong>
                </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="p1" UpdateMode="Conditional" >
                            ...
                            <script type="text/jscript">
                                ...
                                <asp:Button ID="btndel" runat="server" Text="删除" class="btn btn-default" style="width:60px; height:32px;"  OnClick="btndel_Click" />
                                 ...
                                 <dx:aspxgridview ID="gv_d" runat="server" 
                                    AutoGenerateColumns="False" KeyFieldName="numid" Theme="MetropolisBlue"
                                      OnRowCommand="gv_d_RowCommand" 
                                    ClientInstanceName="gv_d"  EnableTheming="True"  
                                    onhtmlrowcreated="gv_d_HtmlRowCreated"  OnCustomCallback="gv_d_CustomCallback" > 
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="采购员/计划员" FieldName="buyer_planner" Width="140px" VisibleIndex="3">
                                            <Settings AllowCellMerge="False" />
                                            <DataItemTemplate>
                                                <dx:ASPxComboBox ID="buyer_planner" runat="server" ValueType="System.String" Width="140px"  
                                                 ClientInstanceName='<%# "buyer_planner"+Container.VisibleIndex.ToString() %>' >
                                                </dx:ASPxComboBox>
                                            </DataItemTemplate>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="是否分销点" FieldName="isfx" Width="60px" VisibleIndex="4">
                                            <Settings AllowCellMerge="False" />
                                             <DataItemTemplate>     
                                        ...
                                        <dx:GridViewDataTextColumn Caption="地点" FieldName="site" Width="80px" VisibleIndex="5">
                                            <Settings AllowCellMerge="False" />
                                            <DataItemTemplate>                
                                              <dx:ASPxComboBox ID="site" runat="server" ValueType="System.String" Width="80px" 
                                                ClientSideEvents-SelectedIndexChanged='<%# "function(s,e){Getcode("+Container.VisibleIndex+");}" %>' 
                                               ClientInstanceName='<%# "site"+Container.VisibleIndex.ToString() %>'>
                                                </dx:ASPxComboBox>
                                            </DataItemTemplate>        
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="分销网代码" FieldName="fxcode" Width="80px" VisibleIndex="6">
                                            <Settings AllowCellMerge="False" />
                                            <DataItemTemplate>                
                                                 <dx:ASPxTextBox ID="fxcode" Width="80px" runat="server"  Value='<%# Eval("fxcode")%>' ReadOnly="true"
                                                  ClientInstanceName='<%# "fxcode"+Container.VisibleIndex.ToString() %>'>
                                                </dx:ASPxTextBox>      
                                            </DataItemTemplate>        
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="采购/制造" FieldName="pt_pm_code" Width="40px" VisibleIndex="7">
                                            <Settings AllowCellMerge="False" />
                                            <DataItemTemplate>
                                                <dx:ASPxLabel ID="pt_pm_code" runat="server" Text="D" Width="40px" >
                                                </dx:ASPxLabel>
                                            </DataItemTemplate>
                                        </dx:GridViewDataTextColumn>

                                         <dx:GridViewDataTextColumn Caption="订货方法" FieldName="dhff" 
                                         ...
                                         <dx:GridViewDataTextColumn Caption="订货周期" 
                                            FieldName="dhperiod" Width="60px" VisibleIndex="9">
                                            <Settings AllowCellMerge="False" />
                                            <DataItemTemplate>                
                                             ...
                                             <dx:GridViewDataTextColumn Caption="安全提前期" 
                                            FieldName="aqtj_wuliu" Width="60px" VisibleIndex="10">
                                            <DataItemTemplate>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="最小订单量" 
                                            FieldName="quantity_min" Width="60px" VisibleIndex="12">
                                             <DataItemTemplate>
                                                        <dx:ASPxTextBox ID="quantity_min" Width="60px" runat="server" Value='<%# Eval("quantity_min")%>'
                                                    ClientSideEvents-ValueChanged='<%# "function(s,e){RefreshRow("+Container.VisibleIndex+");}" %>' 
                                        ...
                                        <dx:GridViewDataTextColumn Caption="最大订单量" 
                                            FieldName="quantity_max" Width="60px" VisibleIndex="13">
                                            <Settings AllowCellMerge="False" />
                                            <DataItemTemplate>                
                                                            <dx:ASPxTextBox ID="quantity_max" Width="60px" runat="server" Value='<%# Eval("quantity_max")%>'
                                                    ClientSideEvents-ValueChanged='<%# "function(s,e){RefreshRow("+Container.VisibleIndex+");}" %>' 
                                        ...
                                        <dx:GridViewDataTextColumn Caption="订单倍数" FieldName="ddbs" 
                                            Width="60px" VisibleIndex="14">
                                            <Settings AllowCellMerge="False"/>
                                            <DataItemTemplate>
                                                    <dx:ASPxTextBox ID="ddbs" Width="60px" runat="server" Value='<%# Eval("ddbs")%>'
                                                    ClientSideEvents-ValueChanged='<%# "function(s,e){RefreshRow("+Container.VisibleIndex+");}" %>' 
                                        ...
                                        <dx:GridViewDataTextColumn Caption="订单数量" FieldName="ddsl" 
                                        ...
                                        <dx:GridViewDataTextColumn Caption="采购提前期" 
                                            FieldName="purchase_days" Width="60px" VisibleIndex="18">
                                            <DataItemTemplate>
                                                <dx:ASPxTextBox ID="purchase_days" Width="60px" runat="server" Value='<%# Eval("purchase_days")%>'
                                                    ClientSideEvents-ValueChanged='<%# "function(s,e){RefreshRow("+Container.VisibleIndex+");}" %>' 
                                        ...
                                        <dx:GridViewDataTextColumn Caption="制造提前期" 
                                            FieldName="make_days" Width="60px" VisibleIndex="11">
                                            <DataItemTemplate>
                                      ...
                                      <dx:GridViewDataTextColumn FieldName="" Caption=" " VisibleIndex="99" >
                                            <Settings AllowCellMerge="False" />
                                            <DataItemTemplate>                
                                                <dx:ASPxButton ID="btn" runat="server" Text="新增行"   
                                                    CommandName="Add"  ></dx:ASPxButton>          
                                            </DataItemTemplate>                        
                                        </dx:GridViewDataTextColumn>
                                    </Columns>                                                
                                    <Styles>
                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"  data-toggle="collapse" data-target="#PE">
                            <strong style="padding-right: 100px">签核完成并对接QAD才算完成.</strong>
                        </div>
                        <div class="panel-body  <% =Session["lv"].ToString() != "" ? "" : "collapse" %>" id="PE">
                            <div class="col-xs-12 col-sm-12  col-md-12 col-lg-12">
                                <div>
                                    <table style="width: 80%; height:100px" border="0" runat="server" id="Table1" >
                                        <tr>
                                            <td style=" width:150px; color:Red; ">处理完请勾选 :</td>
                                            <td>
                                         <asp:CheckBoxList ID="ddlopinion" runat="server" CssClass="form-control " RepeatDirection="Vertical" Width="200px" Height="100px"></asp:CheckBoxList>
                                                </td>
