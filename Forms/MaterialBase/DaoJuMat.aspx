...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //默认刀具角数为1
            $("#djjs").val($("#djjs").val()==""?"1":$("#djjs").val());
            //自动获取描述
            $("#var1,#var2,#var3,#var4,#var13,#zongchang,#float1,#float2,#float3,#var6,#var8").change(function(){
                getMS();
            });
            //自动获取额定寿命
            $("#var1,#var2,#var3 ,#var4,#var5,#var6,#var7,#var9,#var10 ,#var11,#var12,#var13,#zongchang").change(function(){
                getEDSM();
            });
        ...
        function validate(id){
            ...
            if(type=="钻头"||type=="铣刀"||type=="拉刀"||type=="铰刀"||type=="倒角刀"||type=="特殊刀具"){
        ...
        function getMS(){
            ...
            var ms="";  
            if(val=="钻头"){
                if($("#var1").val()!=""&&$("#var1").val()!="-"){ ms+="D"+$("#var1").val(); }
                if($("#var2").val()!=""&&$("#var2").val()!="-"){ ms+="*"+$("#var2").val()+"L";}
                if($("#var3").val()!=""&&$("#var3").val()!="-"){ ms+="*D"+$("#var3").val(); }
                if($("#var4").val()!=""&&$("#var4").val()!="-"){ ms+="*"+$("#var4").val()+"L";  }
                if($("#var13").val()!=""&&$("#var13").val()!="-"){ ms+="*D"+$("#var13").val();}
                if($("#zongchang").val()!=""&&$("#zongchang").val()!="-"){ ms+="*"+$("#zongchang").val()+"L"; }
            }
	        else if(val=="铣刀"){
                if($("#float1").val()!=""&&$("#float1").val()!="-"){ ms+="D"+$("#float1").val(); }
                if($("#var2").val()!=""&&$("#var2").val()!="-"){ ms+="*"+$("#var2").val()+"L";}
                if($("#var3").val()!=""&&$("#var3").val()!="-"){ ms+="*D"+$("#var3").val(); }
                if($("#var4").val()!=""&&$("#var4").val()!="-"){ ms+="*"+$("#var4").val()+"L";  }
                if($("#var6").val()!=""&&$("#var6").val()!="-"){ ms+="*D"+$("#var6").val();}
                if($("#zongchang").val()!=""&&$("#zongchang").val()!="-"){ ms+="*"+$("#zongchang").val()+"L"; }
            }
	        else if(val=="丝锥"){
                if($("#var1").val()!=""&&$("#var1").val()!="-"){ ms+=$("#var1").val(); }
                if($("#var2").val()!=""&&$("#var2").val()!="-"){ ms+="*"+$("#var2").val()+"L";}
                if($("#var3").val()!=""&&$("#var3").val()!="-"){ ms+=" "+$("#var3").val(); }
                if($("#var4").val()!=""&&$("#var4").val()!="-"){ ms+=" "+$("#var4").val()  }                
            }
	        else  if(val=="铰刀"){
                if($("#float1").val()!=""&&$("#float1").val()!="-"){ ms+="D"+$("#float1").val(); }
                if($("#float2").val()!=""&&$("#float2").val()!="-"){ ms+="*"+$("#float2").val()+"L";}
                if($("#var1").val()!=""&&$("#var1").val()!="-"){ ms+="*D"+$("#var1").val(); }
                if($("#var2").val()!=""&&$("#var2").val()!="-"){ ms+="*"+$("#var2").val()+"L";  }
                if($("#var7").val()!=""&&$("#var7").val()!="-"){ ms+="*D"+$("#var7").val();}
                if($("#zongchang").val()!=""&&$("#zongchang").val()!="-"){ ms+="*"+$("#zongchang").val()+"L"; }
            }
	        else  if(val=="毛刷"){
                if($("#float1").val()!=""&&$("#float1").val()!="-"){ ms+="D"+$("#float1").val(); }
                if($("#float2").val()!=""&&$("#float2").val()!="-"){ ms+="*"+$("#float2").val()+"L";}
                if($("#float3").val()!=""&&$("#float3").val()!="-"){ ms+="*D"+$("#float3").val(); }
                if($("#zongchang").val()!=""&&$("#zongchang").val()!="-"){ ms+="*"+$("#zongchang").val()+"L"; }
            }
	        else if(val=="特殊刀具"){
                if($("#float1").val()!=""&&$("#float1").val()!="-"){ ms+="D"+$("#float1").val(); }
                ...
                if($("#var3").val()!=""&&$("#var3").val()!="-"){ ms+="*D"+$("#var3").val(); }
		        if($("#zongchang").val()!=""&&$("#zongchang").val()!="-"){ ms+="*"+$("#zongchang").val()+"L"; }
                if($("#var8").val()!=""&&$("#var8").val()!="-"){ ms+=" "+$("#var8").val();  }                
                
            }
	        else  if(val=="倒角刀"){
                if($("#var1").val()!=""&&$("#var1").val()!="-"){ ms+="D"+$("#var1").val(); }
                if($("#var2").val()!=""&&$("#var2").val()!="-"){ ms+="*"+$("#var2").val()+"°";}
                if($("#var3").val()!=""&&$("#var3").val()!="-"){ ms+="*"+$("#var3").val()+"L"; }
                if($("#zongchang").val()!=""&&$("#zongchang").val()!="-"&&$("#zongchang").val()!=undefined){ ms+="*"+$("#zongchang").val()+"L"; }
            }

            //为空填写自动拼接描述，不为空不更新
            //if($("#ms").val()==""){$("#ms").val(ms);}
            //else{
            //    layer.confirm('描述已有值，是否使用自动拼接描述【'+ms+'】替换?', {
            //        btn: ['是','否'] //按钮
            //    }, function(index){
            //        $("#ms").val(ms);layer.close(index);
            //    })                
            //}
            $("#ms").val(ms);
                        ...
                        <div class="panel-body   collapse in" id="PC">
                            <div class="col-xs-12 col-sm-12  col-md-12 col-lg-12">
                                ...
                                <div>
                                    ...
                                    <span style="color:orangered">备注：若为新刀，零星刀【新安全库存】可填数量 0；若为旧刀,【新安全库存】与【安全库存(仓库)】不一致则视为修改库存。</span>
                                </div>
                            </div>                             
                        </div>
                    </div>
