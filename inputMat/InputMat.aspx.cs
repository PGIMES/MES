...
public partial class InputMat : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            dtpihao = Function_TouLiaoRL.TouLiao_RL_NO_query(txtBanBie.Value, txtBanZu.Value, txtSheBeiHao.Value, selHeJin.Value);
    ...
    protected void btnTouLiao_confirm_1_Click(object sender, EventArgs e)
    {
        ...
        Function_TouLiaoRL.touliao_rl_insert(dropGongHao.SelectedValue, txtXingMing.Value, txtBanBie.Value, txtBanZu.Value, txtSheBeiHao.Value, txtSheBeiJianCheng.Value, "", selHeJin.Value, type, txt_maozhong_1.Text, txt_pizhong_1.Text, txt_touliao_1.Text, txtmaterial_lot.Text);
        // txt_maozhong_1 .b
       ...
       // btnTouLiao_confirm_1. CssClass = "btn btn-large btn-primary disabled";
        ...
        txtPiHao.Value = Function_TouLiaoRL.TouLiao_RL_NO_query(txtBanBie.Value, txtBanZu.Value, txtSheBeiHao.Value, selHeJin.Value).Rows[0]["touliaono"].ToString();
        Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "layer.alert('投料成功！')", true);
