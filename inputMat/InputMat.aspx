...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function show() {
                ...
                function setWeight(result) {
                     if ($("input[id*='txt_maozhong_1']").attr("class") == "input form-control") { $("input[id*='txt_maozhong_1']").val(result); }
                                    if ($("input[id*='txt_pizhong_1']").attr("class") == "input form-control") { $("input[id*='txt_pizhong_1']").val(result); }
                                    if ($("input[id*='txt_maozhong_1']").val() != "" && $("input[id*='txt_pizhong_1']").val() != "") {
                                        $("input[id*='txt_touliao_1']").val($("input[id*='txt_maozhong_1']").val() - $("input[id*='txt_pizhong_1']").val())
                                    }

                }
                //                $.post(url, { emp_no: "" }, function (result) {
                //                    //alert($("input[id*='txt_maozhong_1']").attr("class"));
                //                    alert(result);
                //                    if ($("input[id*='txt_maozhong_1']").attr("class") == "input form-control") { $("input[id*='txt_maozhong_1']").val(result); }
                //                    if ($("input[id*='txt_pizhong_1']").attr("class") == "input form-control") { $("input[id*='txt_pizhong_1']").val(result); }
                //                    if ($("input[id*='txt_maozhong_1']").val() != "" && $("input[id*='txt_pizhong_1']").val() != "") {
        ...
        function btnTouLiao_confirm_1_onclick() {
                    ...
                    <div class="col-sm-10">
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="selHeJin" class="form-control input-s-sm" runat="server">
                                        <option value="A380">A380</option>
                                        <option value="EN46000">EN46000</option>
                                        <option value="ADC12">ADC12</option>
                                        <option value="EN47100">EN47100</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="col-sm-2" style="float: left">
                        <div class="area area_border_gray" style="width: 100%; height: 100%">
                            ...
                            <div style="width: 100%; height: 100%">
                                <label id="hejin" style="font-size: xx-large">
                                    A380</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="col-sm-12">
                                        <div class="area_block">
                                            <div class="btn-padding-s btn-yellow "  >
                                                <div class="area_x_lg">
