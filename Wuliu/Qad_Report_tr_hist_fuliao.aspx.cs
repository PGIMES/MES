...
public partial class Wuliu_Qad_Report_tr_hist_fuliao : System.Web.UI.Page
{
    ...
    public void QueryASPxGridView()
    {
        ...
        DataTable dt = DbHelperSQL.Query("exec [Report_tr_hist_fuliao] '2','" + ddl_comp.SelectedValue 
    ...
    {
        QueryASPxGridView();
        gv_tr_list.ExportXlsxToResponse("辅料库龄明细" + System.DateTime.Now.ToShortDateString(), new DevExpress.XtraPrinting.XlsxExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
    }
