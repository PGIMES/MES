       ...
       <div class=" panel panel-info col-md-6 ">
            ...
            <div class="panel panel-body" style="  overflow:scroll">
                <div style="float: left">
                    ...
                    <dx:WebChartControl ID="ChartC" runat="server" CrosshairEnabled="True" Height="300px" Width="500px" Visible="false">
                    </dx:WebChartControl>
                    <dx:WebChartControl ID="ChartC_1" runat="server" CrosshairEnabled="True" Height="300px" Width="500px">
                    </dx:WebChartControl>
                </div>
            </div>
        </div>
       ...
       <div class=" panel panel-info col-md-6 ">
            ...
            <div class="panel panel-body" style="  overflow:scroll">
                <div style="float: left">
                    ...
                    <dx:WebChartControl ID="ChartE" runat="server" CrosshairEnabled="True" Height="300px" Width="500px" Visible="false">
                    </dx:WebChartControl>

                    <dx:WebChartControl ID="ChartE_1" runat="server" CrosshairEnabled="True" Height="300px" Width="500px">
                    </dx:WebChartControl>
                </div>
            </div>
        </div>
