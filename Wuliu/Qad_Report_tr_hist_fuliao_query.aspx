<%@ Page Title="【辅料库龄分析】" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Qad_Report_tr_hist_fuliao_query.aspx.cs" Inherits="Wuliu_Qad_Report_tr_hist_fuliao_query" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <div>
       ...
       <div class=" panel panel-info col-md-7 ">
            <div class="panel panel-heading">
                <asp:Label ID="Label6" runat="server" Text="库龄180天-360天库龄分析"></asp:Label>
       ...
       <div class=" panel panel-info col-md-5 ">
            ...
            <div class="panel panel-body" style="  overflow:scroll;height:500px;">
                <div style="float: left">
                    ...
                    <dx:WebChartControl ID="ChartF" runat="server" CrosshairEnabled="True" Height="300px" Width="500px">
                    </dx:WebChartControl>
                </div>
            </div>
       </div>
       <div class=" panel panel-info col-md-7 ">
            <div class="panel panel-heading">
                <asp:Label ID="Label4" runat="server" Text="超360天库龄分析"></asp:Label>
                <button id="btn_export3" type="button" class="btn btn-primary btn-large" runat="server" onserverclick="btn_export3_ServerClick" style="padding:0px 0px">
                    <i class="fa fa-download fa-fw"></i>&nbsp;导出清单
                </button>
            </div>
            <div class="panel panel-body" style="  overflow:scroll;height:500px;">
                <div style="float: left">
                    ...
                    <dx:WebChartControl ID="ChartG" runat="server" CrosshairEnabled="True" Height="300px" Width="500px">
                    </dx:WebChartControl>
                </div>
            </div>
        </div>
