...
public partial class MaterialBase_DJLY_BYTop : System.Web.UI.Page
{
    decimal xmdlys = 0;
    decimal xdlys = 0;
    ...
    {
        //
        DataTable dt = DbHelperSQL.Query("exec Top_byamt_query  '" + ddl_comp.SelectedValue + "','" + dropdl.SelectedValue + "','" + DDL_type.SelectedValue + "','"+dropnum.SelectedValue+"'").Tables[0];
        ViewState["Detail"] = dt;
