<%@ Page Title="Top 异常" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DJ_LY_YC.aspx.cs" Inherits="MaterialBase_DJ_LY_YC" %>
                        ...
                        <table class="tblCondition" >
                            <tr>
                             <td>刀具类型：</td>
                                ...
                                <td>
                                    <asp:DropDownList ID="dropdl" runat="server" class="form-control input-s-sm ">
                                    </asp:DropDownList>
                                </td>
