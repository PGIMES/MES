<%@ Page Title="物料系统【刀具查询】" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="SZ_report_dev.aspx.cs" Inherits="SZ_report_dev" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                    ...
                    <div class="col-sm-12">
                        <table class="tblCondition" >
                            <tr>
                                ...
                                <td>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="Bt_Excel" runat="server" Text="导出Excel" class="btn btn-large btn-primary" OnClick="Bt_Excel_Click" Width="100px" /></td>
    ...
    <div runat="server" id="DIV1" style="margin-left: 5px; margin-right: 5px; margin-bottom: 10px">
        <table>
            <tr>
                <td>
                     <dx:ASPxGridView ID="GV_PART" runat="server" KeyFieldName="wlh" AutoGenerateColumns="False"  OnHtmlDataCellPrepared="GV_PART_HtmlDataCellPrepared" OnHtmlRowPrepared="GV_PART_HtmlRowPrepared" OnHtmlRowCreated="GV_PART_HtmlRowCreated">
