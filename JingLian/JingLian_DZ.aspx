<%@ Page Title="MES【熔炼精炼打渣记录】" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="JingLian_DZ.aspx.cs" Inherits="JingLian_JingLian_DZ" %>
        ...
        <div class="col-sm-12 ">
            ...
            <table border="1" >
             <tr>
                ...
                <tr>  <td><strong>2、精炼剂使用量(2~4Kg)</strong></td>
                ...
                <tr><td><strong>3、除渣剂使用量(5~6Kg)</strong></td>
