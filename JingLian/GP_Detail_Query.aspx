<%@ Page Title="MES【光谱查询】" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GP_Detail_Query.aspx.cs" Inherits="JingLian_GP_Detail_Query" %>
                                ...
                                <asp:Panel ID="Panel2" runat="server" Height="100%" >
                                    <table style=" background-color: #FFFFFF;" >
                                        ...
                                        <td rowspan="2"  valign="top">
                                                        ...
                                                        style=" overflow: scroll; height: 1500px; width:1000px">
                                                                                ...
                                                                                <asp:GridView ID="gv1" runat="server"   Font-Size="12px" 
                                                                                    ...
                                                                                    <Columns>
                                                                                       <asp:BoundField HeaderText="序号">
                                                                                        ...
                                                                                        <asp:BoundField DataField="confirm_time" HeaderText="完成日期">
                                                                                        <HeaderStyle BackColor="#C1E2EB" ForeColor="Brown" />
                                                                                        </asp:BoundField>
                                                                                        <asp:BoundField DataField="dh" 
                                                                                            HeaderStyle-ForeColor="Brown" HeaderText="样件序列号">
                                                                                        <HeaderStyle ForeColor="Brown" BackColor="#C1E2EB" 
                                                                                            Width="150px" />
                                                                                        <ItemStyle Width="100px" Wrap="True" />
                                                                                        </asp:BoundField>
                                                                                        <asp:BoundField DataField="sbno" HeaderText="设备号/批号">
                                                                                        <HeaderStyle BackColor="#C1E2EB" ForeColor="Brown" 
                                                                                            Width="60px" />
                                                                                        </asp:BoundField>
                                                                                        ...
                                                                                        <asp:BoundField DataField="status" 
                                                                                            HeaderText="测试&lt;br&gt;结论" HtmlEncode="False">
                                                                                        <HeaderStyle BackColor="#C1E2EB" ForeColor="Brown" 
                                                                                            Wrap="False" />
                                                                                        </asp:BoundField>
