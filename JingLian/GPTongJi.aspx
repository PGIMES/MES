<%@ Page Title="MES【光谱统计】" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="GPTongJi.aspx.cs" Inherits="GPTongJi" EnableViewState="True" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="dropSource" runat="server" class="form-control input-s-sm">
                        <asp:ListItem Value=""></asp:ListItem>
                        <asp:ListItem Value="精炼机" Text="精炼机"> </asp:ListItem>
                        <asp:ListItem Value="保温炉" Text="保温炉"></asp:ListItem>
                        <asp:ListItem Value="进货" Text="进货"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
    ...
    <div class=" panel panel-info col-lg-6 col-md-8">
        ...
        <div class="panel panel-body" style="  overflow:scroll">
                ...
                <asp:Chart ID="ChartYear" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
                    ...
                    <Series>
                        <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line" LabelBorderWidth="9"
                            Legend="Default" LegendText="测量次数" MarkerSize="8" MarkerStyle="Circle" Name="铝锭重量"
                            ShadowOffset="3">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                ...
                <asp:Chart ID="ChartYearRate" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
                    ...
                    <Series>
                        <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line" LabelBorderWidth="9"
                            Legend="Default" LegendText="测量时长" MarkerSize="8" MarkerStyle="Circle" Name="铝锭占比"
                            ShadowOffset="3">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
    ...
    <div class=" panel panel-info col-lg-6 col-md-12">
        <div class="panel panel-heading">
        ...
        <div class="panel panel-body">
            ...
            <asp:Chart ID="ChartMonth2" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
                    ...
                    <Series>
                        <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line" LabelBorderWidth="9"
                            Legend="Default" LegendText="平均测量时长" MarkerSize="8" MarkerStyle="Circle" Name="平均测量时长"
                            ShadowOffset="3">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
