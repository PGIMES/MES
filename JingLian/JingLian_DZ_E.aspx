<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="JingLian_DZ_E.aspx.cs" Inherits="JingLian_JingLian_DZ_E" %>
        ...
        <div class="col-sm-12 ">
            ...
            <table border="1" >
             <tr>
                ...
                <tr>  <td><strong>2、<span>精炼剂使用量</span><span lang="EN-US">(1~2Kg)</span></strong></td>
                ...
                <tr><td><strong>3、<span>除渣剂使用量</span><span lang="EN-US">(1~2Kg)</span></strong></td>
                <asp:UpdatePanel  runat="server"><ContentTemplate>
                    <td>
