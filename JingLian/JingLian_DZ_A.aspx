<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="JingLian_DZ_A.aspx.cs" Inherits="JingLian_JingLian_DZ_A" %>
        ...
        <div class="col-sm-12 ">
            ...
            <table border="1" >
             <tr>
                ...
                <tr><td><strong>3、除渣剂使用量(2~4Kg)</strong></td>
                <asp:UpdatePanel runat="server"><ContentTemplate>
                    <td>
