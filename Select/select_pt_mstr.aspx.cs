                    ...
                    from (
                        ...
                        from qad.dbo.qad_pt_mstr a
                            where (
                                 ...
                                 or (a.pt_part='P0170AA')  or (a.pt_part='P0739AA-01') or (a.pt_part='P0738AA-01') or (a.pt_part='P0591AA-01')  or (a.pt_part='P0125BA')  or (a.pt_part='P0744AA-02') or (a.pt_part='P0744AA-04') 
                                )                   
                                and a.pt_domain = '{0}' 
                         ) aa where ispodsched=0
                    order by aa.wlh";
