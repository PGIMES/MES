<%@ Page Language="C#" AutoEventWireup="true" CodeFile="select_PlanAttendant_dtl.aspx.cs" Inherits="select_PlanAttendant_dtl" %>
                    ...
                    <td align="center" colspan="2">
                        ...
                        <asp:GridView ID="GridView1" Width="400px"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="workname" HeaderText="姓名"
                                    ReadOnly="True">
                                    <HeaderStyle Wrap="True" />
                                </asp:BoundField>                             
