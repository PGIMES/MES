<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PW_Add_TJReport.aspx.cs" Inherits="PW_PW_Add_TJReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
    .gvHeader th{    background: #C1E2EB;    color:  Brown;    border: solid 1px #333333;    padding:0px 5px 0px 5px;}
   
</style>
    <script src="../Content/js/jquery.min.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            $("#mestitle").text("【钢丸添加统计】");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="panel panel-info">
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="selsb" runat="server" class="form-control input-s-sm">
                    </asp:DropDownList>
                </td>
                <td>
        ...
        <div class="panel panel-body">
            <div  style="float:left">
                <asp:Chart ID="ChartYear" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
                    ...
                    <Series>
                        <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line" LabelBorderWidth="9"
                            Legend="Default" LegendText="重量(Kg)" MarkerSize="8" MarkerStyle="Circle" Name="重量(Kg)"
                            ShadowOffset="3">
                        </asp:Series>
                    </Series>
                ...
                <asp:Chart ID="ChartYearRate" runat="server" BackColor="#F3DFC1" BackGradientStyle="TopBottom"
                    ...
                    <Series>
                        <asp:Series BorderWidth="3" ChartArea="ChartArea1" ChartType="Line" LabelBorderWidth="9"
                            Legend="Default" LegendText="0.6mm占比(%)" MarkerSize="8" MarkerStyle="Circle" Name="0.6mm占比(%)"
                            ShadowOffset="3">
                        </asp:Series>
                    </Series>                    
                    <ChartAreas>
    ...
    <div class="panel panel-info col-lg-12">
     ...
     <asp:GridView ID="GridViewDay" BorderColor="LightGray"  CssClass="gvHeader"
            runat="server" AutoGenerateColumns="False"   BorderWidth="2px"
            Width="1000px" 
