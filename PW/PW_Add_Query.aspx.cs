...
public partial class PW_PW_Add_Query : System.Web.UI.Page
{
    ...
    {
        string strWhere = "select *,round(cast(bs*25 as decimal(18,2)),0) as zl from MES_PW_Add where 1=1";
        if (txtDateTo.Text.Trim() != "")
        {
            strWhere = strWhere + " and add_date<convert(datetime,'" + txtDateTo.Text.Trim() + " 23:59:59')";
        }
        if (Droptype.SelectedValue.Trim() != "")
        {
            strWhere = strWhere + " and wl = '" + Droptype.SelectedValue.Trim() + "'";
        }
        ...
        {
            strWhere = strWhere + " and convert(varchar(4),add_date,111)=" + dropYear.SelectedValue.Trim() + "";
        }
        if (txtDateFrom.Text.Trim() != "")
        {
            strWhere = strWhere + " and add_date > convert(datetime,'" + txtDateFrom.Text.Trim() + " 00:00:00')";
        }

        strWhere = strWhere + " order by add_date desc";
        return strWhere;
