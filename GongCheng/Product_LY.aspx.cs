...
public partial class GongCheng_Product_LY : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (xmh.TrimEnd() != "0")
            {
                 ds = Query("exec  GetSL_DJ '" + comp + "','" + year_start + "','" + mnth_start + "','" + year_end + "','" + mnth_end + "','" + part.TrimEnd() + "','" + xmh.TrimEnd() + "'");

            }
            else
            {
                ds = Query("exec  GetSL_DJ_Group '" + comp + "','" + year_start + "','" + mnth_start + "','" + year_end + "','" + mnth_end + "','" + part.TrimEnd() + "','" + dj_group.TrimEnd() + "'");
