...
namespace WebForm.Platform.WorkFlowDesigner
{
    public partial class Import : Common.BasePage
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string filePath = RoadFlow.Utility.Config.FilePath + "WorkFlowImportFiles\\" + Guid.NewGuid().ToString("N");
            ...
            string msg = new RoadFlow.Platform.WorkFlow().Import(zipFile, 0);
            if ("1" == msg)
            {
