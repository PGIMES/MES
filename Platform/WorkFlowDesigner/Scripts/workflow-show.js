...
var wf_nodeBorderColor = isshowDesign ? "#23508e" : "#7a7a7a";
...
$(function ()
{
    wf_r_width = ismobile ? 1000 : $(window).width() - 20;
    wf_r_height = ismobile ? 800 : $(window).height() - 80;
...
{
    var json = $.ajax({
        url: RoadUI.Core.rooturl() + "/Platform/WorkFlowDesigner/GetJSON.ashx?type=0&appid=&flowid=" + id, async: false, cache: false, dataType: "json", success: function (json)
        {
            reloadFlow(json);
        }
    });
