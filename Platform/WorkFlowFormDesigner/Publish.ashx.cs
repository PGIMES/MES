...
namespace WebForm.Platform.WorkFlowFormDesigner
{
    ...
    public class Publish : IHttpHandler,IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string formats = context.Request["formats"];
            ...
            if (wff == null)
            {
                context.Response.Write("请先保存表单再发布!");
                return;
            }
            ...
            serverScript.Append("\tLitJson.JsonData initData = BWorkFlow.GetFormData(DBConnID, DBTable, DBTablePK, InstanceID, fieldStatus, \"" + formats + "\", TaskID);\r\n");
