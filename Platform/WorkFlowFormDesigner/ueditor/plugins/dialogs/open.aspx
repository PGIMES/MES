...
<form method="post">
            ...
            <td style="vertical-align:top; padding:2px 0 0 3px; border-left:1px solid #cccccc;">
                <div id="ListDiv" style="overflow:auto;">
                    ...
                    <script type="text/javascript">
                        ...
                        {
                            $.ajax({
                                url: "/Platform/WorkFlowFormDesigner/GetHtml.ashx?id=" + id, async: false, cache: false,
                            ...
                            $.ajax({
                                url: "/Platform/WorkFlowFormDesigner/GetAttribute.ashx?id=" + id, dataType: "JSON", async: false, cache: false,
                            ...
                            $.ajax({
                                url: "/Platform/WorkFlowFormDesigner/Getsubtable.ashx?id=" + id, dataType: "JSON", async: false, cache: false,
                                success: function (json)
                                {
                            ...
                            $.ajax({
                                url: "/Platform/WorkFlowFormDesigner/GetEvents.ashx?id=" + id, dataType: "JSON", async: false, cache: false,
                                success: function (json)
                                {
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            roadTree = new RoadUI.Tree({ id: "TypeDiv", path: "/Platform/Dictionary/Tree1.ashx?ischild=1&root=<%=rootid%>", refreshpath: "/Platform/Dictionary/TreeRefresh.ashx", onclick: openUrl });
            openUrl({ id: "<%=rootid%>" });
        });
