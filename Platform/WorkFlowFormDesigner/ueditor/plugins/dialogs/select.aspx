    ...
    <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
        ...
        <tr id="ds_dict">
            ...
            <td><input type="text" class="mydict" id="ds_dict_value" more="0" value="" />
                <input type="checkbox" style="vertical-align:middle; margin-left:15px;" id="ds_dict_ischild" value="0" /><label style="vertical-align:middle;" for="ds_dict_ischild">加载下级</label>
