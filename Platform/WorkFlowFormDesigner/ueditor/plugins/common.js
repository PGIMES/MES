...
function testSql(sql, dbconn)
{
    ...
    $.ajax({
        url: RoadUI.Core.rooturl() + "/Platform/WorkFlowFormDesigner/TestSql.ashx", async: false, cache: false, method: "post", data: { sql: sql, dbconn: dbconn }, success: function (txt)
        {
            alert(txt);
        }
    });
