...
<body>
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="99%" class="formtable">
        <tr>
            ...
            <td>
                <input type="text" name="Title1" id="Title1" class="mytext" runat="server" validate="empty" style="width: 80%" />
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            ...
            <td>
                <textarea class="mytext" name="Script" id="Script" rows="1" cols="1" validate="empty" style="width:80%; height:170px; line-height:16px; color:Blue; font-family:Courier New; padding:5px;" runat="server"></textarea>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <textarea class="mytext" name="Note" id="Note" rows="1" cols="1" style="width:99%; height:50px;" runat="server"></textarea>
            </td>
        </tr>
        </table>
        <div class="buttondiv">
