...
{
    public partial class NoRead : Common.BasePage
    {
        ...
        private void initData()
        {
            ...
            string pager;
            MsgList = new RoadFlow.Platform.ShortMessage().GetList(out pager, new int[] { 0 }, query, s_Title1, s_Contents, s_SenderID, s_Date1, s_Date2, CurrentUserID.ToString());
