<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TableEdit_MySql.aspx.cs" Inherits="WebForm.Platform.DBConnection.TableEdit_MySql" %>
        ...
        <table class="listtable" style="table-layout:fixed;WORD-BREAK:break-all;WORD-WRAP:break-word;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><select class="myselect" name="<%=dr["f_name"] %>_type" onchange="typeChange(this)" style="width:90%"><%=DBConn.GetFieldDataTypeOptions(dr["t_name"].ToString(), "mysql") %></select></td>
