    ...
    <table class="listtable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%=(button.Ico.IsNullOrEmpty()?"": button.Ico.IsFontIco() ? "<i class='fa " + button.Ico + "' style='font-size:14px;vertical-align:middle;margin-right:3px;'></i>" : "<img src='../.."+button.Ico+"'/>") %></td>
