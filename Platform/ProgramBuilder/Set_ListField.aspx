<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Set_ListField.aspx.cs" Inherits="WebForm.Platform.ProgramBuilder.Set_ListField" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function add(id)
        {
            window.location = "Set_ListField_Add.aspx?fid=" + (id || "") + "<%=query%>";
        }
        function del()
        {
