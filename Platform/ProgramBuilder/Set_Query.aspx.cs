...
{
    public partial class Set_Query : Common.BasePage
    {
        protected string query = string.Empty;
        protected List<RoadFlow.Data.Model.ProgramBuilderQuerys> fieldList = new List<RoadFlow.Data.Model.ProgramBuilderQuerys>();
        protected RoadFlow.Platform.ProgramBuilderQuerys Querys = new RoadFlow.Platform.ProgramBuilderQuerys();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            RoadFlow.Platform.Log.Add("删除了应用程序设计查询", pid, RoadFlow.Platform.Log.Types.其它分类);
            InitData();
        }
    }
}