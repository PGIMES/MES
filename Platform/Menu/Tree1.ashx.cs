...
namespace WebForm.Platform.Menu
{
    ...
    public class Tree1 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            json.AppendFormat("\"ico\":\"{0}\",", rootDr["AppIco"].ToString().IsNullOrEmpty() ? "" : rootDr["AppIco"].ToString());
            ...
            for (int i = 0; i < apps.Length; i++)
            {
                ...
                json.AppendFormat("\"ico\":\"{0}\",", dr["AppIco"].ToString().IsNullOrEmpty() ? "" : dr["AppIco"].ToString());
