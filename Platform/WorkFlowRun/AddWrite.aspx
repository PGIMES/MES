<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWrite.aspx.cs" Inherits="WebForm.Platform.WorkFlowRun.AddWrite" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="95%" align="center" class="formtable" style="margin-top:6px;">
        ...
        <tr>
            <th>加签人员：</th>
            <td>
                <input type="text" class="mymember" id="writeuser" name="writeuser" validate="empty" style="width:60%;" />
            </td>
        </tr>
        <tr>
            <th>加签说明：</th>
            <td>
                <textarea class="mytextarea" id="note" name="note" style="width:98%; height:80px;"></textarea>
            </td>
        </tr>
    </table>
    <div class="buttondiv">
        <asp:Button ID="Button1" runat="server" CssClass="mybutton" Text="&nbsp;确&nbsp;认&nbsp;" OnClick="Button1_Click" OnClientClick="return new RoadUI.Validate().validateForm(document.forms[0]);" />
