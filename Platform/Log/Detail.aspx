...
<body>
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="99%" class="formtable">
        ...
        <tr id="contentstr" runat="server">
            <th>日志内容：</th>
            <td><textarea class="mytextarea" style="width:99%; height:200px;word-break:break-all; font-family:'Courier New';word-wrap:break-word;"><asp:Literal ID="Contents" runat="server"></asp:Literal></textarea></td>
        </tr>
        
        <tr id="oldxmlstr" runat="server">
            <th>修改前：</th>
            <td><textarea class="mytextarea" style="width:99%; height:200px;word-break:break-all; font-family:'Courier New';word-wrap:break-word;"><asp:Literal ID="OldXml" runat="server"></asp:Literal></textarea></td>
        </tr>
        <tr id="newxmlstr" runat="server">
            <th>修改后：</th>
            <td><textarea class="mytextarea" style="width:99%; height:200px;word-break:break-all; font-family:'Courier New';word-wrap:break-word;"><asp:Literal ID="NewXml" runat="server"></asp:Literal></textarea></td>
        </tr>
    </table>
    <div class="buttondiv">
