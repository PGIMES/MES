...
<body>
            ...
            <td>
                <table cellpadding="0" cellspacing="1" border="0">
                    <tr>
                        ...
                        <td><asp:Button ID="Button3" runat="server" Text="确定移动" OnClientClick="return deptmove3();" CssClass="mybutton" OnClick="Button3_Click" /></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div style="width:95%; margin:10px auto 10px auto; text-align:center;">
        ...
        <asp:Button ID="Button2" runat="server" Text="删除" CssClass="mybutton" OnClientClick="return confirm('您真的要删除该机构及其下级机构吗?');" OnClick="Button2_Click" />
        <asp:Button ID="Button4" runat="server" Text="同步到微信" CssClass="mybutton" OnClientClick="return confirm('真的要将整个组织机构同步到微信吗?');" OnClick="Button4_Click" />
    </div>
    </form>
    ...
    <script type="text/javascript">
        ...
        function setMenu()
        {
            var url="SetMenu.aspx?prev=Body.aspx?1=1<%=query%>";
            window.location=url;
            return false;
        }
    </script>
