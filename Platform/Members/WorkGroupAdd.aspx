...
<body>
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="95%" class="formtable">
        <tr>
            ...
            <td><input type="text" id="Name" name="Name" class="mytext" runat="server" validate="empty,minmax" value="" max="100" style="width:75%" /></td>
        </tr>
        <tr>
            <th style="width:80px;">成员：</th>
            <td><input type="text" id="Members" name="Members" class="mymember" runat="server" validate="empty" value="" style="width:65%" /></td>
        </tr>
        <tr>
