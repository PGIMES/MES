    ...
    this.init = function ($files)
    {
        $files.each(function ()
        {
            ...
            $but.bind("click", function ()
            {
                ...
                new RoadUI.Window().open({ id: "file_" + id, url: "/Controls/UploadFiles/" + (ismobile ? "Default_App.aspx" : "Default.aspx") + "?eid=" + id + "&files=" + val + "&filetype=" + filetype, width: ismobile ? 320 : 800, height: ismobile ? 300 : 500, title: "附件管理", showclose: true });
            });
