...
RoadUI.Core = {
    ...
    rooturl: function ()
    {
        ...
        else
        {
            ...
            if (cookie == "undefined") { cookie = "";}//fish added
            return cookie || "";
        }
    },
    ...
    loadOptions: function linkageField(select)
    {
        ...
        switch(linkagesource)
        {
            ...
            case "dict":
                $.ajax({
                    url: this.rooturl() + "/Platform/WorkFlowRun/GetLinkageOptions.aspx", async: false, cache: false, type: "POST", data: { "linkagesource": linkagesource, "linkagesourcetext": linkagesourcetext, "linkagesourceconn": linkagesourceconn, "value": value }, success: function (options)
                    {
