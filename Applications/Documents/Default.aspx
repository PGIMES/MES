<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebForm.Applications.Documents.Default" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            ...
            <td class="organizesplit" style="padding:0;">
                <iframe id="<%=Iframeid %>" frameborder="0" scrolling="auto" src="ListNoRead.aspx?<%=Query %>" style="width:100%;margin:0;padding:0;"></iframe> 
            </td>
        </tr>
    </table>
