...
namespace WebForm.Applications.Documents
{
    public partial class List : Common.BasePage
    {
        ...
        protected bool HasManage = false;
        protected bool HasPublish = false;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HasManage = DocDir.HasManage(DirID.ToGuid(), CurrentUserID);
            HasPublish = DocDir.HasPublish(DirID.ToGuid(), CurrentUserID);
