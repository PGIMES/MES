...
public partial class Daoju_Daoju_List : System.Web.UI.Page
{
    ...
    {
        string lssql = "exec [Pgi_Base_DaoJu_Form_Query] '','"+this.txtpgi_no.Text+"','"+this.txtpn.Text+"','"+this.txtdept.Text+"','"+this.txtproduct_user.Text+"','"+this.txtver.Text+"'";
        ...
        if (this.gv1.VisibleRowCount>0)
        {
            ...
            DataTable ldt1 = DbHelperSQL.Query("exec Pgi_Base_DaoJu_Form_Dt_Query '" + this.gv1.GetRowValues(lnindex, "pgi_no").ToString() + "','" + this.gv1.GetRowValues(lnindex, "op").ToString() + "','" + this.gv1.GetRowValues(lnindex, "ver").ToString() + "'").Tables[0];
