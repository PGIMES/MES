<%@ Page Title="【项目任务完成率统计报表】" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="APQP_Rate_TJ.aspx.cs" Inherits="XM_APQP_Rate_TJ" EnableViewState="True"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class=" panel panel-info col-lg-5 " >
        ...
        <div class="panel panel-body">
            <div style="float: left">
                ...
                <asp:GridView ID="GridViewYear" BorderColor="lightgray"   BorderWidth="2px"
    ...
    <div class=" panel panel-info  col-lg-7 ">
        ...
        <div class="panel panel-body">
          <dx:WebChartControl ID="WebChartControl2" 
            ...
            <asp:GridView ID="GridViewMonth" runat="server" BorderColor="lightgray"   BorderWidth="2px" OnRowCreated="GridViewMonth_RowCreated">
            </asp:GridView>
        </div>
    </div>
    <%--日--%>
    <div class="panel panel-info  col-lg-12">
        ...
        <asp:GridView ID="GridViewDay" BorderColor="lightgray" runat="server" AutoGenerateColumns="true" BorderWidth="2px"
